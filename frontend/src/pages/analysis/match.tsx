...
export default function MatchAnalysisPage() {
  ...
  if (loading) {
    return (
      <div data-testid="page-analysis">
        <h1 className="text-2xl font-bold text-brand-black">{da.analysis.title}</h1>
        <p className="text-neutral-mid-gray mt-2">{da.common.loading}</p>
      </div>
    );
  }
  ...
  return (
    <div data-testid="page-analysis">
      ...
      {/* DBU Summary Cards */}
      <div className="grid grid-cols-4 gap-4 mb-6" data-testid="analysis-summary">
